...
static void txfsk (uint8_t *buffer, size_t len_buffer) {
...
static void txlora (uint8_t *buffer, size_t len_buffer) {
...
static void starttx (uint8_t *buffer, size_t len_buffer) {
...
//enum { RXMODE_SINGLE, RXMODE_SCAN, RXMODE_RSSI };===================================NEW
...
void radio_tx(uint8_t *buffer, size_t len_buffer)
{
	hal_disableIRQs();
